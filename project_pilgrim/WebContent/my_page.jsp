...
// SeminarReservationService 통해 예약 정보 가져오기
...
<div class="container my_page">
	<div class="title_wrap">
		...
		<h2><%=member_id%>님 환영합니다.
		</h2>

		<div class="actions two_btn">
			<a href="myInfolist.mb?member_id= <%=member_id%>"
				class="button big special">나의 정보</a>
			<!-- 로그아웃 버튼 -->
	...
	<div class="reservation_wrap">
		...
		<p>
			...
			%>
			예약 번호:
			<%=roomReservation.getReservation_id()%><br> 투숙객 수:
			<%=roomReservation.getGuest_count()%><br> 체크인 날짜:
		...
		%>
		예약 정보가 없습니다. <a href="room_rqt.jsp" class="res_cancel">예약하기</a>
		<hr>
		<%
		}
		%>
	...
	<div class="reservation_wrap">
		...
		<p>
			...
			%>
			예약 번호:
			<%=seminarReservation.getReservation_id()%><br> 세미나 타임:
		...
		%>
		예약 정보가 없습니다. <a href="seminar_rqt.jsp" class="res_cancel">예약하기</a>
		<hr>
		<%
		}
		%>
	...
	<div class="reservation_wrap">
		...
		<p>
			...
			%>
			예약 번호:
			<%=facilityReservation.getReservation_id()%><br> 시설 타입:
		...
		%>
		예약 정보가 없습니다. <a href="facility_rqt.jsp" class="res_cancel">예약하기</a>
		<%
		}
		%>
		</p>
