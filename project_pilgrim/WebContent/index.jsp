			...
			<section id="banner_4" class="banner swiper-slide"><h2>Pilgrim House</h2>
				...
				<ul class="actions"><li><a href="#" class="button special big">천로역정 세미나 예약</a></li>
						...
						<header class="major special"><h2>Mauris vulputate dolor</h2>
							...
							<div class="feature">
								<div class="image rounded"><img src="assets/images/pic04.jpg" alt="" width="169" height="169"></div>
								<div class="content">
							...
							<div class="feature">
								<div class="image rounded"><img src="assets/images/pic05.jpg" alt="" width="169" height="169"></div>
								<div class="content">
							...
							<div class="feature">
								<div class="image rounded"><img src="assets/images/pic06.jpg" alt="" width="169" height="169"></div>
								<div class="content">
							...
							<div class="feature">
								<div class="image rounded"><img src="assets/images/pic07.jpg" alt="" width="169" height="169"></div>
								<div class="content">
