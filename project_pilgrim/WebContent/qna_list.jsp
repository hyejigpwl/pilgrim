		...
		<tbody>
			...
			<c:forEach var="qna" items="${ qnaList }" varStatus="status">
				<tr>
					...
					<td class="count">${qna.getView_count()}</td>
				</tr>
			</c:forEach>

		</tbody>
	</table>
	<a href="qnaWriteForm.qa?p=${ param.p }"
...
<div class="pagination_wrap" align="center">
	<ul class="pagination justify-content-center">
		<c:if test="${ pageInfo.getStartPage() != 1 }">
			<li class="page-item page-link"><a href="qnaList.qa?p=1"><i
					class="fas fa-fast-backward"></i></a></li>
			<li class="page-item page-link"><a
				href="qnaList.qa?p=${ pageInfo.getStartPage() - 10 }"><i
		...
		<c:forEach var="page_num" begin="${ pageInfo.getStartPage() }"
			...
			<li
				...
				href="qnaList.qa?p=${ page_num }">${ page_num }</a></li>
		</c:forEach>
		...
		<c:if test="${ pageInfo.getEndPage() < pageInfo.getTotalPage() }">
			...
			<li class="page-item page-link"><a
				href="qnaList.qa?p=${ pageInfo.getTotalPage() }"><i
